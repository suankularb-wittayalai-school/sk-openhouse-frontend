...
type RegisterationTicketDialogProps = {
  people: Person[];
  onClose: () => void;
};
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <div className="flex flex-col gap-1">
          ...
          <Card className="flex flex-col gap-0! p-0!">
            {people.map((person, idx) => (
              <PersonCard person={person} count={idx + 1} key={person.id} />
            ))}
          </Card>
        </div>
        <div className="text-primary! flex flex-col gap-1 text-sm!">
          ...
          <ol>
            <li>
              โปรดถ่ายภาพหน้าจอ หรือพิมพ์ตั๋วใบนี้ให้กับผู้เข้าร่วมคนอื่น&nbsp;ๆ
...
export default RegisterationTicketDialog;
