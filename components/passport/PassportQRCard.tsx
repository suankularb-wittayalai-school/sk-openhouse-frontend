...
const PassportQRCard: StylableFC<{
  passportId: string;
  owner: string;
}> = ({ passportId, owner, className, style }) => (
  <div
    className={cn(
  ...
  >
    ...
    <div className="relative h-full">
      <div
        className="border-primary-border absolute top-1/2 left-1/2 aspect-square
          w-3/4 -translate-1/2 rounded-lg border-2 bg-white p-2"
      >
        <QRCode
          value={"https://o.mysk.school/p/" + passportId}
          level="Q"
          bgColor="transparent"
