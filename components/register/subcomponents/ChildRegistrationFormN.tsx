...
const ChildRegistrationFormN: FC<ChildRegisterationFormProps> = ({
  count,
  onDelete,
}) => {
  ...
  const fp = (
    s: FieldPath<FamilyCreate["children"]["0"]>,
  ): FieldPath<FamilyCreate> =>
    (`children.${count - 1}.` + s) as FieldPath<FamilyCreate>;
...
export default ChildRegistrationFormN;
